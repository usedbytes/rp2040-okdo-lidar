...
// Uses DMA to capture the frame data, validates it, and then places
// in a queue for handling by user code.
//
// With the exception of CalCRC8: Copyright 2024 Brian Starkey
...
static bool frame_valid(LiDARFrameTypeDef *frame)
{
